...
const Home = () => {
  ...
  const templates = [
    { id: 1, img: image, title: "Template 1", description: "Description for template 1" },
    { id: 2, img: image, title: "Template 2", description: "Description for template 2" },
    { id: 3, img: image, title: "Template 3", description: "Description for template 3" },
    { id: 4, img: image, title: "Template 4", description: "Description for template 4" },
    { id: 5, img: image, title: "Template 5", description: "Description for template 5" },
